...
<script>
  var i = 0 ;
  var j = pid_js_count.length;
document.getElementById("SortBystatus").onclick = Oyelami_sort(status_js,pid1_js64  );
...
<script>
  var i = 0 ;
var j = pid_js_count.length;
document.getElementById("SortByPID1").onclick = Oyelami_sort(pid1_js64,status_js);
...
document.getElementById("btn115").addEventListener("click", function(){
  ...
  document.getElementById("table225").style.display = "none";
  document.getElementById("table11005").style.display = "none";
});
document.getElementById("btn225").addEventListener("click", function(){
  document.getElementById("table225").style.display = "block";
  document.getElementById("table115").style.display = "none";
  document.getElementById("table11005").style.display = "none";
});
...
<script>
  var i = 0 ;
  var j = pid_js_count.length;
document.getElementById("SortByPID").onclick = Oyelami_sort(pid_js64,appdate_js  );
...
<script>
  var i = 0 ;
var j = pid_js_count.length;
document.getElementById("SortByAPP").onclick = Oyelami_sort(appdate_js,pid_js64);
