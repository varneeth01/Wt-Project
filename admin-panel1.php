...
$password = 'varneeth'; 
$database = 'myhmsdb'; 
$socket = '/run/mysqld/mysqld.sock'; // Use the correct socket path from my.cnf
...
if (isset($_POST['docsub1'])) {
    ...
    if ($result) {
        ...
        echo "<script>alert('Unable to delete: " . mysqli_error($con) . "');</script>";
    }
}
?>
<html lang="en">
...
if ($result->num_rows > 0) {
  ...
  for ($i = 0; $i < $num; $i++){
      ...
      $username = [];  // Make sure $username is an array
      $docFees = [];  // Make sure $docFees is an array
      
      // Fetching data and appending to arrays
