...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #3f5efb, #fc466b); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>MabbuL HOSPITALS</h4></a>
                ...
                <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="submit" id="inputbtn" name="docsub" value="Login" class="btn btn-primary">
                                    </div>
                                </div>
                            </form>
                            </div>
